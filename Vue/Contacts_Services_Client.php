...
<head>
	...
	<div class="global">
		...
		<div class="droite">
			...
			<form method="POST" action="Contacts_Services_Client.php">
				<h1 class="title_contacts">Envoyez nous un mail</h1>
				...
				<fieldset>
					...
					<legend>Vos coordonnées :</legend>
						...
						<label>Votre Nom :</label>
							<input type="name" name="name" size="40" maxlength="20" id="name" placeholder="ex : Feng">

						<label>Votre numéro de tel :</label>
							<input type="num_tel" name="num_tel" size="40" maxlength="15" id="num_tel" placeholder="ex : 06 64 79 59 **">

						<label>Votre Adresse :</label>
							<input type="num_rue" name="num_rue" size="40" maxlength="15" id="num_rue" placeholder="Num">
							<input type="nom_rue" name="nom_rue" size="40" maxlength="20" id="nom_rue" placeholder="Nom de rue">
								<select name="country">
							...
							<input type="num_appart" name="num_appart" size="40" maxlength="5" id="num_appart" placeholder="Num appartement">
				...
				<fieldset>
					...
					<label for="mail">Votre mail :</label>
						<input type="email" name="email" size="40" maxlength="50" id="email" placeholder="ex : ***@gmail.com">
