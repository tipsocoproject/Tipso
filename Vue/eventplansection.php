					...
					if(strlen($select) > 2)
					{
						...
						if(isset($_POST['confirm-time']))
						{
							...
							elseif ($selecttype == "Température")
							{
								...
								{
									echo '<td><input class="input-box" name="heure" type="time" value='.$selecttime.'><td>';
									echo '<td><select class="input-box" name="modification"><option selected="selected">'.$tempval."°C".'</option><option>15°C</option><option>16°C</option><option>17°C</option><option>18°C</option><option>19°C</option><option>20°C</option><option>21°C</option><option>22°C</option><option>23°C</option><option>24°C</option><option>25°C</option><option>26°C</option><option>27°C</option><option>28°C</option><option>29°C</option><option>30°C</option></select></td>';
									$button = '<input id="button" type="submit" name="confirm-final" value="Valider">';
									$returnbutton = '<input id="button" type="submit" name="return-button" value="Retour">';
								...
								{
									echo '<td><input class="input-box" name="heure" type="time" value='.$selecttime.'></td>';
									echo '<td><select class="input-box" name="modification" disabled><option selected="selected">&nbsp</option><option>15</option><option>16</option><option>17</option><option>18</option><option>19</option><option>20</option><option>21</option><option>22</option><option>23</option><option>24</option><option>25</option><option>26</option><option>27</option><option>28</option><option>29</option><option>30</option></select></td>';
									$button = '<input id="button" type="submit" name="confirm-final" value="Valider">';
									$returnbutton = '<input id="button" type="submit" name="return-button" value="Retour">';
	...
	<?php 
	if(isset($mess) || isset($_POST['confirm-final']))
	{
