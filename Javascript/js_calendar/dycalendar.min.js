...
!function(t){
	...
	{var a,n,r,d,l,i;
		for(a=s.createElement("table"),n=s.createElement("tr"),l=0;6>=l;l+=1)
			r=s.createElement("td"),r.innerHTML="DLMMJVS"[l],n.appendChild(r);
		for(a.appendChild(n),n=s.createElement("tr"),l=0;6>=l&&l!==t.firstDayIndex;l+=1)
			r=s.createElement("td"),n.appendChild(r);for(i=1;6>=l;)r=s.createElement("td"),
			r.innerHTML=i,
